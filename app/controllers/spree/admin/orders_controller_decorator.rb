  ...
  def get_inpost_info
    if @order
      ...
      if @inpost_machine.present?
        ...
        @machine_info = [
          hash["paczkomaty"]["machine"]["town"],
          hash["paczkomaty"]["machine"]["street"],
          hash["paczkomaty"]["machine"]["buildingnumber"],
          hash["paczkomaty"]["machine"]["postcode"],
          hash["paczkomaty"]["machine"]["town"],
          hash["paczkomaty"]["machine"]["locationdescription"]
        ].join(' ')
      end
    end
  end
